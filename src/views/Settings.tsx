...
export const Settings: React.FC = () => {
  ...
  return (
    <div className="-m-4 md:-m-8 p-4 md:p-8 bg-[#0A0A0A] text-[#B4B4B4] min-h-[calc(100vh-4rem)] md:min-h-screen font-sans">
      {/* Top Header Section */}
      <div className="flex justify-between items-start mb-8 pt-4 md:pt-0">
        <div>
          ...
          <p className="text-[#B4B4B4] mt-1">Logotipo, dados e preferências</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {/* Logo Card */}
          <div className="bg-[#18181A] rounded-2xl p-6 shadow-xl shadow-black/20 border border-[#27272A]/50">
            <div className="border-2 border-dashed border-[#27272A]/70 rounded-xl p-8 flex flex-col items-center justify-center text-center transition-colors hover:bg-[#27272A]/30 cursor-pointer">
              ...
              <h3 className="text-[#B4B4B4] font-medium text-lg leading-snug">
            ...
            <div className="mt-6 flex justify-start">
              <button 
                ...
                className="bg-[#27272A] hover:bg-[#3F3F46] text-[#B4B4B4] px-5 py-2.5 rounded-xl font-medium flex items-center gap-2 transition-colors border border-[#27272A]/50"
              >
          ...
          <div className="bg-[#18181A] rounded-2xl p-6 shadow-xl shadow-black/20 border border-[#27272A]/50">
            ...
            <form onSubmit={handleSave} className="space-y-5">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#B4B4B4] tracking-widest uppercase">Nome do Negócio</label>
                <input 
                  type="text" 
                  value={localSettings.nome_loja}
                  onChange={e => setLocalSettings({...localSettings, nome_loja: e.target.value})}
                  className="w-full px-4 py-3 bg-[#0A0A0A] text-white rounded-xl border border-[#27272A] focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition-all placeholder:text-[#B4B4B4]"
                  placeholder="Nome da sua loja"
                />
              </div>
              
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#B4B4B4] tracking-widest uppercase">NIF / NIPC</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#B4B4B4] tracking-widest uppercase">Telefone</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#B4B4B4] tracking-widest uppercase">Email (Vendedor)</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#B4B4B4] tracking-widest uppercase">Endereço</label>
                <input 
                  type="text" 
              ...
              <div className="pt-2">
                <button 
                  type="submit"
                  className="w-full sm:w-auto bg-gradient-to-r from-purple-500 to-purple-600   text-white px-6 py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-purple-500/20 flex items-center justify-center gap-2"
                >
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-[#18181A] rounded-2xl p-6 shadow-xl shadow-black/20 border border-[#27272A]/50">
            <p className="text-[#B4B4B4] text-sm leading-relaxed mb-6">
              Esta mensagem aparecerá automaticamente em todas as faturas.
            </p>
            <button 
              onClick={() => handleSave()}
              className="bg-gradient-to-r from-purple-500 to-purple-600   text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-purple-500/20 flex items-center justify-center gap-2"
            >
          ...
          <div className="bg-[#18181A] rounded-2xl p-6 shadow-xl shadow-black/20 border border-[#27272A]/50">
            ...
            <div className="bg-[#27272A] rounded-xl p-5 border border-[#27272A]">
               <p className="text-[#B4B4B4] text-sm leading-relaxed text-center mb-4">
                 As configurações acima serão aplicadas em todas as faturas emitidas.
               </p>
               <p className="text-[#B4B4B4] text-sm text-center leading-relaxed">
